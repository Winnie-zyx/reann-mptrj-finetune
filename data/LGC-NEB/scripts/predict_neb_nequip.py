#!/usr/bin/env python3
"""Calculate energies for VASP POSCAR images with a deployed NequIP model."""
...
def main() -> None:
    ...
    species_to_type_name = {symbol: symbol for symbol in chemical_symbols if symbol}
    calc = NequIPCalculator.from_deployed_model(
        model_path=str(model), species_to_type_name=species_to_type_name
    )
    rows = []
